...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('ZSR2-Est2g', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('KNuAzXPkdj', 0, 'Lo2TCPrDaCD9npW9PBjml+', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'recipe', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_c4f1f0fd278fa23bd2a2f8aa3557910f2a78a844696da588214d5a81de038cee');
    ...
    protected function getSecurity_Firewall_Map_Context_DefaultService()
    {
        ...
        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/recipe/*/id');
        ...
        $l->add($k, array(0 => 'ROLE_ADMIN', 1 => 'ROLE_USER'), NULL);

        $m = new \Symfony\Component\Security\Core\User\InMemoryUserProvider();
        $m->createUser(new \Symfony\Component\Security\Core\User\User('user', '$2y$12$5NMAwmNa8aebygeWdRWRlufW23M2.Ibzgr6X7C0OUaDk0fDuk/7iC', array(0 => 'ROLE_USER')));
        $m->createUser(new \Symfony\Component\Security\Core\User\User('matt', '$2y$12$MS4PoFxfJIdv/KkuwI/2RuBSVdop1PJlsso4HGHUrS7icCaboS6G6', array(0 => 'ROLE_ADMIN')));
        $m->createUser(new \Symfony\Component\Security\Core\User\User('admin', '$2y$12$iG57pC9Lxt8yKPrh9koSyOVGYjLlidTNVI01f.xsESdy5o4fHcsmO', array(0 => 'ROLE_ADMIN')));
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+T-03eRIAO', 0, 'Lo2TCPrDaCD9npW9PBjml+', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
