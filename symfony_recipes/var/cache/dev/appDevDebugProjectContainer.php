...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('KNuAzXPkdj', 0, 'ids8+begQMD9QRuPHDKAQb', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_DefaultService()
    {
        ...
        $m->createUser(new \Symfony\Component\Security\Core\User\User('matt', '$2y$12$iG57pC9Lxt8yKPrh9koSyOVGYjLlidTNVI01f.xsESdy5o4fHcsmO', array(0 => 'ROLE_ADMIN')));
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+T-03eRIAO', 0, 'ids8+begQMD9QRuPHDKAQb', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
