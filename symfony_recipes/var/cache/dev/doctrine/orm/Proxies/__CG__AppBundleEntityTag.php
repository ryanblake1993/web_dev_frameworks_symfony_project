...
class Tag extends \AppBundle\Entity\Tag implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Tag' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Tag' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Tag' . "\0" . 'vote', '' . "\0" . 'AppBundle\\Entity\\Tag' . "\0" . 'recipes', '' . "\0" . 'AppBundle\\Entity\\Tag' . "\0" . 'username'];
        }
    ...
    public function setRecipes($recipes)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setRecipes', [$recipes]);

        return parent::setRecipes($recipes);
    }
